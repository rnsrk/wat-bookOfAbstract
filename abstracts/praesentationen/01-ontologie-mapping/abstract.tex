...
\begin{beitrag}[Anke Albrecht, Bernd Braun]{Ontologie-Mapping zwischen CIDOC CRM und FRBRoo in WissKI}{%
...
\begin{abstract}
Das Forschungsprojekt "Korrespondenznetze des langen 19. Jahrhunderts" stand vor der Herausforderung, CIDOC CRM und FRBRoo gleichzeitig in einer WissKI-Instanz zu nutzen; dazu wurden relevante FRBRoo-Klassen identifiziert, ihre Subsumtionsbeziehungen zu CRM-Klassen dokumentiert und ein Mapping-Dossier mit SPARQL-konformen Definitionen und Pathbuilder-Implementierungen erstellt. Auf technischer Ebene wurde eine konsistente URI-Strategie über beide Ontologien hinweg umgesetzt und ein SHACL-validiertes Mapping-Register aufgebaut. Die wichtigste Erkenntnis betrifft die Grenzen der strikten FRBRoo-Trennung von Werk, Expression und Manifestation im historischen Korrespondenzkontext; als Reaktion wurden dokumentierte Vereinfachungsprofile definiert, die die ontologischen Entscheidungen nachvollziehbar und reversibel halten.
\end{abstract}

\section{Einleitung}
Die parallele Erfassung von Ereignissen, Akteur*innen, Objekten und literarischen Werken stellt geisteswissenschaftliche Sammlungsprojekte regelmäßig vor das Problem, dass zwei eng verwandte, aber unterschiedlich modellierte Ontologien gleichzeitig benötigt werden. Während das \emph{CIDOC Conceptual Reference Model} (CRM) als de-facto-Standard für die ereignisorientierte Modellierung kulturellen Erbes etabliert ist,\footnote{Aktuelle Spezifikation: CIDOC CRM v7.1.3, hrsg. von der CIDOC CRM Special Interest Group, ICOM 2024.} kommt für die Erschließung von Texten, Editionen und Werkfassungen häufig die Erweiterung FRBRoo zum Einsatz.\footnote{FRBRoo (\emph{Functional Requirements for Bibliographic Records -- object-oriented}) harmonisiert die IFLA-FRBR-Familie mit dem CIDOC CRM.
Seit 2016 wird das Modell unter dem Namen LRMoo (\emph{Library Reference Model -- object-oriented}) weiterentwickelt.
Im vorliegenden Projekt wurde bewusst FRBRoo v2.4 eingesetzt, da die zum Projektbeginn vorhandenen Pathbuilder-Pfade auf dieser Klassenstruktur aufgebaut waren und eine Migration auf LRMoo den Rahmen des Projekts überstiegen hätte.} Im Forschungsprojekt \glqq Korrespondenznetze des langen 19.\,Jahrhunderts\grqq{} mussten beide Modelle in einer einzigen WissKI-Instanz produktiv koexistieren -- ein Anwendungsfall, der über die Standardpfade des WissKI-Pathbuilders hinausgeht und systematische Entscheidungen über Klassen-, Property- und Identitätsabbildungen erfordert. Der vorliegende Beitrag dokumentiert die methodischen Grundlagen, die Werkzeugkette und die Erkenntnisse aus zwei Jahren Mapping-Praxis.
...
In Bezug auf die WissKI-Werkzeuglandschaft hat sich die Pathbuilder-Oberfläche als robust, aber für komplexe Doppelontologien als unterspezifiziert erwiesen. Wir schlagen daher die Aufnahme einer dedizierten Mapping-Dokumentation als JSON-Sidecar in zukünftige Pathbuilder-Versionen vor. Erste prototypische Implementierungen sind in Abstimmung mit dem WissKI-Kernteam erfolgt und werden im Rahmen des Vortrags demonstriert.\footcite[vgl. auch][92]{braun2025-pathbuilder}

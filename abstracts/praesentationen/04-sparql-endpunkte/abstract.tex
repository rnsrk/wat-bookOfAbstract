...
Auf Anwendungsseite stellen die Endpunkte sowohl eine klassische SPARQL-Schnittstelle als auch eine kuratierte Sammlung vorgefertigter Abfragen zur Verfügung. Diese vorgefertigten Abfragen sind nicht nur ein Werkzeug für die Wissensvermittlung, sondern auch ein Test-Set für die kontinuierliche Validierung: Wenn sich nach einer Aktualisierung das Ergebnis einer dieser Abfragen ändert, wird das automatisch protokolliert und vom Projektteam geprüft. Eine systematische Auswertung der so erfassten Veränderungen ist inzwischen erschienen.\footcite{hauser2025-endpunkt-monitoring}
